...
public class Boss2ScriptB : MonoBehaviour
{
    int direction = 1;
    ...
    public GameObject launchedfireball;
    ...
    void MeteorShot()
    {
        Instantiate(launchedfireball, Turret.transform.position, Turret.transform.rotation);
    }
